...
<head>
    ...
    {{-- Favicon inline (opsional, biarkan seperti sumber) --}}
    ...
    {{-- CSS Mazer (ubah path sesuai penempatan asetmu) --}}
    <link rel="stylesheet" href="{{ asset('assets/compiled/css/app.css') }}" crossorigin>
    <link rel="stylesheet" href="{{ asset('assets/compiled/css/app-dark.css') }}" crossorigin>
    <link rel="stylesheet" href="{{ asset('assets/compiled/css/iconly.css') }}" crossorigin>

    @stack('styles')
</head>
<body>
    
    {{-- init tema dark/light --}}
    ...
    @stack('scripts-base') {{-- tempat untuk script umum halaman sebelum charts --}}

    {{-- Slot script khusus halaman (chart, dsb) --}}
    @stack('scripts')
</body>
</html>
