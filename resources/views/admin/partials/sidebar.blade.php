    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="theme-toggle d-flex gap-2 align-items-center mt-2">
                    {{-- ikon & toggle seperti sumber --}}
                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="20" height="20"
                        class="iconify iconify--system-uicons" viewBox="0 0 21 21">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="20" height="20"
                        class="iconify iconify--mdi" viewBox="0 0 24 24">
                        <path fill="currentColor" d="m17.75 4.09-2.53 1.94..."></path>
                    </svg>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                {{-- Contoh item aktif berdasarkan rute --}}
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item {{ request()->routeIs('admin.laporan.diproses') ? 'active' : '' }}">
                            <a href="{{ route('admin.laporan.diproses') }}" class="submenu-link">Diproses</a>
                        </li>
                        <li class="submenu-item {{ request()->routeIs('admin.laporan.selesai') ? 'active' : '' }}">
                            <a href="{{ route('admin.laporan.selesai') }}" class="submenu-link">Selesai</a>
                        </li>
                ...
                <li class="sidebar-item">
                    <x-logout-button class='sidebar-link'/>
                </li>
                </a>
